...
class Conference(models.Model):
    ...
    ratingTotal = models.IntegerField(default=0, null=True, blank=True)
...
class Event(models.Model):
    ...
    eventID = models.ManyToManyField(Faculty, max_length=30, null=True, blank=True)
...
class Post(models.Model):
    ...
    postID = models.ManyToManyField(Faculty, max_length=20, null=True, blank=True)
...
class Rating(models.Model):
    ...
    ratingID = models.ManyToManyField(Faculty, null=True, blank=True)
